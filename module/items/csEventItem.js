...
export class CSEventItem extends CSItem {
    generateModifiers(choices) {
        ...
        this.update({"system.modifiers": system.modifiers});
    }

    _generateModifier(resource, data) {
        LOGGER.trace(`generate the modifier to ${resource} | CSEventItem.js`);

        let formula = system.playerChoice ? system.bonusToChoices : system.formulas[resource];
        ...
        system.modifiers[resource] = roll.total;
    }
}